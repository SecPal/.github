...
Browser titles and generated document titles should identify the current content first, then the product. Use a spaced en dash between title parts.
...
- `<Page title> – <Product>`
- `<Entity name> – <Section> – <Product>`
- `<Product>`

Use the product-name-only fallback when the current route, document, or preview has no stable page or entity title.
