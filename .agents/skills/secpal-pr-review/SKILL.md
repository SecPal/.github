...
empty delivery commit. Require the complete final reviewed-state and eligibility
artifacts. Derive `REVIEWED_BUT_INELIGIBLE` when the target is present in final
